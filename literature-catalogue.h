...
private:
  ...
  void remove_entry_at(const size_t id_to_remove); // Private 
  void edit_entry_at(const size_t id_to_edit); // Private implementation
public:
  // Rule of 5
  // .. Default constructor
  Catalogue();
  ...
  void edit_entry(); // Public interface
